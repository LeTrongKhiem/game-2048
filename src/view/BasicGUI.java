...
public class BasicGUI extends JFrame implements ViewInterface {
	...
	private synchronized void createAndShowGUI(int numTilesX, int numTilesY) {
		...
		StringBuilder instructions = new StringBuilder(
				"<html><b>HOW TO PLAY:</b> Use your <b>arrow keys</b> or <b>WASD keys</b> to move the tiles. ");
//
	...
	public synchronized void showLoss() {
		String[] options = { "Bat dau game moi", "Thoat" };
		int i = JOptionPane.showOptionDialog(null, "Ban da thua", "Game Over!", JOptionPane.DEFAULT_OPTION,
